void transi () {
  ...
  textSize(20);
  text("Vous prenez donc un bateau pour Mégalonisos et arrivez le lendemain dans une magnifique cité pourtant marquée par la crise politique en cours. Les rues sont désertes, les commerces fermés, et les seules personnnes que vous croisez sont des soldats en patrouille. Vous leur demandez donc le chemin à suivre pour aller jusqu'au palais royal. Ils vous l'indiquent légèrement intrigués par votre présence", 60, 140, width/3.5, height/2);
}
